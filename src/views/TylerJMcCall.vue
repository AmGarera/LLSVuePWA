  ...
  <div id="Tyler">
    ...
    <section>
      <div style="margin: 0px 80px" class="container is-fluid">
        <p style="padding: 60px 0px;" class="header-font"><b>An Instagram marketing expert, Tyler simplifies Instagram for entrepreneurs and creatives. </b>
        </p>
        <!--Client Images-->
        ...
        <div class="columns">
          <div class="column">
            <img src="../../static/img/HP/tyler7-06.png" alt="Client Image">
          </div>
        </div>
